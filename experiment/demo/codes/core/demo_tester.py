...
class DemoTester(BaseTester):
    def __init__(self, args, load_dir='', diffusion_load_dir='', device='cuda', model_type="pointnet", diff_model_type="IPFC_Obj"):
        super(DemoTester, self).__init__(args, load_dir, model_type=model_type)         
        self.eval_metrics = cfg.TEST.eval_metrics
        self.eval_history = {}
