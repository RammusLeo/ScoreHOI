...
class ContactFormer(nn.Module):
    def __init__(self):
        ...
        self.fc_out_object_floor = nn.Linear(self.dim, 1)
    ...
    def forward(self, human_kps, object_kps, human_tokens, object_tokens):
        ...
        o_f_contacts = self.fc_out_object_floor(contact_object_tokens)[:,:,0].sigmoid()
        return human_tokens, object_tokens, h_contacts, o_contacts, o_f_contacts
